...
type Weaken<T, U extends keyof T> = { [k in keyof T]: k extends U ? any : T[k] };
...
const storybookConfig: CustomizedStorybookConfig = {
  ...
  addons: ['@storybook/addon-links', '@storybook/addon-essentials', 'storybook-dark-mode', '@storybook/addon-mdx-gfm'],
  framework: {
